    ...
    return (
        <div className="flex min-h-[100dvh] flex-col">
            ...
            <main className="flex-1">
                ...
                {/*             ASA Engine Equipment is a supplier of locomotive engine parts to railroad operators, */}
                            ...
                            <div className="space-y-2">
                                ...
                                <article className="flex flex-col gap-6" data-aos='fade-up'>
                                    <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                        ...
                                        since 20 years, our reputation in the railroad & marine industry is the direct
                                        reflection of our commitment to integrity at every level of our business.
                                    </p>
                                    <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                        With the strength and experience gained through decades of service, we are able
                                        to offer an unbeatable combination of Quality and price. We specialize in
                                        aftermarket parts for GE, EMD and ALCO Engines.
                                    </p>
                                    <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                        ASA Engine equipment is a privately held exporting company that develops,
                                        produces, sources through its manufacturing associate companies and export
                                        quality locomotive parts for GE,EMD and ALCO engines. We represent many leading
                                        ISO 9001/IATF 16949 Quality Management System Certified Indian companies who are
                                    ...
                                    <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                        ...
                                        of several QMS certified companies we represent for export of their locomotive
                                        parts. This also allows us to offer even parts which are either absolute or hard
                                        to source or not in production through reverse engineering.
                                    </p>
                                </article>
                            </div>
                        </div>
                    ...
                    <div className="container mx-auto flex flex-col gap-7 px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                    ASA Engine Equipment has a portfolio of successful projects that showcase our
                        ...
                        <div className="items-middle mx-auto grid max-w-5xl gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-2">
                            <div className="grid gap-1 rounded-lg bg-white p-6 shadow-lg" data-aos='fade-up'>
                                ...
                                <p className="text-gray-500 dark:text-gray-400">
                                    We at ASA Engine equipment are highly responsive to our customer’s part needs,
                                    feedbacks and issues. We believe in building long term customer relationship by
                                    understanding customer requirements and grow through identifying better ways to
                                    serve All customers.
                                </p>
                            </div>
                            <div className="grid gap-1 rounded-lg bg-white p-6 shadow-lg" data-aos='fade-up'>
                            ...
                            <div className="grid gap-1 rounded-lg bg-white p-6 shadow-lg" data-aos='fade-up'>
                                ...
                                <p className="text-gray-500 dark:text-gray-400">
                                    ...
                                    ASA Engine Equipment prides our self on providing on time delivery of the finished
                                    engine spare parts, using a proven process that allows for a quick turn-around from
                                    quote to delivery.
                                </p>
                            </div>
                            <div className="grid gap-1 rounded-lg bg-white p-6 shadow-lg" data-aos='fade-up'>
                                ...
                                <p className="text-gray-500 dark:text-gray-400">
                                    We at ASA Engine Equipment aims to achieve Customer satisfaction by collecting
                                    customer feedback, turning customer feedbacks into action, improving our product and
                                    services and follow up with our Customers on regular basis.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto flex flex-col gap-20 px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2" data-aos='fade-up'>
                                ...
                                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                    ...
                                    wide range of construction services, including commercial, residential, and
                        ...
                        <div className="mx-auto grid max-w-5xl items-start gap-8 text-center sm:grid-cols-2 md:gap-20 lg:grid-cols-3" data-aos='fade-up'>
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">EMD OEM Parts</p>
                            </div>
                            <div className="grid gap-1">
                                <HomeIcon className="mx-auto h-20 w-20 text-gray-500 dark:text-gray-400" />
                                <h3 className="text-lg font-bold">ALCO</h3>
                                <p className="text-sm text-gray-500 dark:text-gray-400">ALCO OEM Parts</p>
                            </div>
                            <div className="grid gap-1">
                                <RouteIcon className="mx-auto h-20 w-20 text-gray-500 dark:text-gray-400" />
                                <h3 className="text-lg font-bold">GE</h3>
                                <p className="text-sm text-gray-500 dark:text-gray-400">GE OEM Parts</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                                    If you have a Locomotive project in mind, we'd love to hear from you. Contact us
                                    today to discuss your needs and get a free quote.
                                </p>
                            </div>
                            <div className="mx-auto w-full max-w-sm space-y-2">
                                ...
                                <form className="flex space-x-2">
                                    <Input className="max-w-lg flex-1" placeholder="Project Details" type="text" />
